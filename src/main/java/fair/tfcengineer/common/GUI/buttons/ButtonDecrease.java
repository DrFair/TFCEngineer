...
public class ButtonDecrease extends GuiButton {

    public ButtonDecrease(int id, int xPos, int yPos) {
        super(id, xPos, yPos, "");
        width = 14;
        height = 14;
    }
    ...
    public void drawButton(Minecraft mc, int x, int y) {
        if (visible) {
            ...
            mouseDragged(mc, x, y);
            drawTexturedModalRect(xPosition, yPosition, 0, 60 + state * 14, 14, 14);
        }
    }
